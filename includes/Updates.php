 ...
 * real site, and the same rule the client plugin's connection credentials
 * follow.
 */
final class Updates {
	 ...
	 */
	public const OPTION = 'bwx_forge_update_token';
	 ...
	 */
	public const CACHE_PREFIX = 'bwx_forge_update_status_';
