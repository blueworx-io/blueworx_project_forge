 ...
 * others (Luke, 2026-09-17; 5 min, 4 and 5 hours added 2026-09-24), so the box
 * is a pick rather than a number. Five and ten minutes are stored as 0.08 and
 * 0.17 hours, which is what two decimal places allow.
 */
export const HOUR_OPTIONS: Array< { value: string; label: string } > = [
  { value: '0.08', label: '5 min' },
